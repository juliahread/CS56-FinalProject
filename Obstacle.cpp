...
Obstacle::Obstacle() {}
Obstacle::Obstacle(std::string sprite_name, int num_sprites, int frame_number,
...
SDL_Rect Obstacle::get_bbox() const { return m_bbox; }

SpriteSheet* Obstacle::get_sprite() const { return m_sprite; }

const SDL_Point* Obstacle::getLocation() const { return &m_pos; }
